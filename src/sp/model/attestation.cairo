...
/// What users send and receive, for external use only.
...
/// What we actually store, for internal use only.
/// Data is stored separately in a mapping due to a layout issue.
#[derive(PartialEq, Drop, Serde, Copy, starknet::Store)]
struct AttestationInternal {
    schema_id: u64,
    linked_attestation_id: u64,
    attest_timestamp: u64,
    revoke_timestamp: u64,
