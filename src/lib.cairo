...
mod interfaces;
    ...
    struct Storage {
        ...
        attestationDatas: LegacyMap::<felt252, Array::<felt252>>,
    ...
    impl SASImpl of ISAS<ContractState> {
        fn self_attest(ref self: ContractState, attestationId: felt252, schemaId: felt252, validUntil: u64, data: Array::<felt252>) {
        ...
        fn self_attest_batch(ref self: ContractState, attestationId: Array::<felt252>, schemaId: Array::<felt252>, validUntil: Array::<u64>, data: Array::<Array::<felt252>>) {
            let mut i: u32 = 0;
        ...
        fn notary_attest(ref self: ContractState, attestationId: felt252, schemaId: felt252, attesterSig: Signature, attester: ContractAddress, validUntil: u64, data: Array::<felt252>) {
            self._validate_attest_input_or_throw(attestationId, schemaId, validUntil);
            self._write_attestation_to_storage(
                attestationId: attestationId, 
    ...
    impl SASInternalFunctions of SASInternalFunctionsTrait {
        ...
        fn _write_attestation_to_storage(ref self: ContractState, attestationId: felt252, attesterSig: Signature, schemaId: felt252, attester: ContractAddress, notary: ContractAddress, validUntil: u64, revoked: bool, data: Array::<felt252>) {
